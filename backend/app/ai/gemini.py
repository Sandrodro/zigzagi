...
_EXTRACT_PROMPT = (
    ...
    "არ დააბრუნო კროსვორდისთვის შეუფერებელი სიტყვები (ნაწილაკები, კავშირები და მისთ.), "
    "მაგალითად: განა, ვით, რად, ჯერ, აბა, მათ, დეე, გან, დგა. "
    "lemma ველში დააბრუნე მხოლოდ არსებითი სახელების ლემები. "
    "თუ სიტყვა ზმნაა და საწყისის ფორმაში არ არის, ლემად დააბრუნე მისი მხოლობითი "
    "რიცხვის მე-3 პირის ფორმა (არა საწყისი), მაგ. ვცდილობ → ცდილობს. "
